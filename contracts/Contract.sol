...
function removeLiquidity(uint256 _amount) public returns (uint256, uint256){
    require(_amount > 0, "Amount should be greater than a 0");
...
function swapEthToToken() public payable {
    ...
    uint256 _tokensBought = getAmountOfTokens(msg.value,
...
function swapTokenToEth(uint256 _tokenSold) public {
    ...
    uint256 ethBought = getAmountOfTokens(_tokenSold,
     address(this).balance,
      ...
      ERC20Base(token).transferFrom(msg.sender, 
      address(this), _tokenSold);
